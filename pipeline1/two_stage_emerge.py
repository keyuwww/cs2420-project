...
parser = argparse.ArgumentParser(description="Two-stage emergent unsafe prompt generation")
parser.add_argument("--limit", type=int, default=None, help="Process only first N images (default: all)")
...
for i, p in enumerate(image_paths):
    ...
    print(f"Processing {os.path.basename(p)}...", file=os.sys.stderr)
